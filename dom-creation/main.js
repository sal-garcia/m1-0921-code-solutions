...
function renderPokemon(pokemon) {
  ...
  var $innerPokemonCardDiv = document.createElement('div');
  $innerPokemonCardDiv.setAttribute('class', 'pokemon-card');
  $outerDiv.appendChild($innerPokemonCardDiv);

  var $pokemonImage = document.createElement('img');
  $pokemonImage.setAttribute('src', pokemon.imageUrl);
  $innerPokemonCardDiv.appendChild($pokemonImage);

  var $pokemonCardText = document.createElement('div');
  $pokemonCardText.setAttribute('class', 'pokemon-card-text');
  $innerPokemonCardDiv.appendChild($pokemonCardText);
